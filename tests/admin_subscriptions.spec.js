...
//   test('View admin subscriptions via API', async ({ request }) => {
//     // Get auth token using helper
//     const token = await getAuthToken(request);

//     // Make the listview_partner API call
//     const response = await request.post(`${BASE_URL}/view_subscription`, {
//       headers: {
...
//     await test.info().attach('View Admin Subscriptions Response', {
